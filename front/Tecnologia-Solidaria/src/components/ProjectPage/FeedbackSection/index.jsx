        ...
        <main>
          ...
          <div className="row">
            ...
            <div className="col-sm">
              ...
              <p style="color: var(--cor-paragrafoD);">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Libero quibusdam vero ipsa doloremque illo nisi exercitationem suscipit odio eligendi dolore maiores doloribus, modi ea sapiente provident nulla earum? Voluptate, aliquam?</p>
            </div>
          </div>
        </main>
      </section>
